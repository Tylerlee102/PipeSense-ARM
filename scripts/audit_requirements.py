...
CHECKS = {
    ...
    "Complete FPGA synthesis": ("synth/production_ecp5.ys", ["pipesense_fpga_top", "synth_ecp5", "arm_like_core.sv", "simple_memory.sv"]),
    "Published adaptive baseline": ("docs/adaptive_baseline.md", ["10.1109/ASYNC.2003.1199165", "architectural approximation", "seeds 1 through 500"]),
    "Standard benchmark honesty": ("benchmarks/standard/README.md", ["does **not** currently execute full CoreMark", "Dhrystone 2.1", "compiler backend"]),
    "Publication evidence": ("docs/publication_evidence.md", ["27-configuration", "source_manifest.csv", "power is unavailable"]),
