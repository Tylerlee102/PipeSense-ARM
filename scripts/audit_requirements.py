...
CHECKS = {
    ...
    "Benchmarks": ("tb/benchmark_programs.sv", ["load_arithmetic_heavy", "load_branch_heavy", "load_memory_heavy", "load_load_use_heavy", "load_mixed_control", "load_tiny_fir", "load_dhrystone_toy", "load_coremark_toy"]),
