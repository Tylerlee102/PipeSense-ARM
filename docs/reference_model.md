...
`scripts/isa_reference.py` is a sequential golden model for the simplified PipeSense educational ISA. It executes the same ten benchmark programs at the architectural level and writes:
